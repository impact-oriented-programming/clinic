...
class Calendar(HTMLCalendar):
    ...
    def formatday(self, day, events):
        ...
        if day != 0:
            if(date.today() == date(int(self.year), int(self.month), my_day)): # catch today to change it's background color, text in white for contrast
    ...
    def formatmonth(self, withyear=True):
        ...
        cal = f'<table border="0" cellpadding="0" cellspacing="0" class="calendar" style="color: #182232; background: white;">\n'
